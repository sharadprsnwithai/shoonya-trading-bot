...
class RsiHighwayMarketBreadthServiceTest {
    ...
    private final RsiHighwayMarketBreadthService breadthService =
            new RsiHighwayMarketBreadthService();
    ...
    void testHealthyMarketBreadthOpensHighway() {
        ...
        MarketBreadthSnapshot snapshot =
                breadthService.evaluateBreadth(candlesMap, indexCandles, 5, 0.20);
        ...
        for (int i = 0; i < 250; i++) {
            list.add(
                    new Candle(
                            "SYM",
                            "D",
                            Instant.now().minusSeconds((250 - i) * 86400L),
    ...
    private List<Candle> createIndexCandles(double drawdownPct) {
        ...
        list.add(
                new Candle(
                        "NIFTY_MIDCAP",
                        "D",
                        Instant.now().minusSeconds(864000L),
        ...
        list.add(
                new Candle(
                        ...
                        BigDecimal.valueOf(currentPrice + 100),
                        BigDecimal.valueOf(currentPrice - 100),
                        BigDecimal.valueOf(currentPrice),
                        100000L));
        return list;
